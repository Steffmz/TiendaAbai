    ...
    <div class="w-full flex justify-center mb-6 flex-shrink-0">
      <div class="flex flex-col md:flex-row items-center gap-3 w-full max-w-3xl">
        <input
          ...
          class="w-64 md:flex-1 px-3 py-2 border border-yellow-400 rounded-lg
                 text-blue-800 bg-blue-50 focus:outline-none focus:border-blue-400
                 focus:ring-2 focus:ring-blue-200 text-sm shadow-sm transition-all duration-200"
        />
        <button
        ...
        <table>
          ...
          <tbody>
            ...
            <tr v-if="loading" v-for="i in 4" :key="i">
              ...
              <td><BaseSkeleton width="100px" height="24px" radius="6px" /></td>
              <td>
              ...
              <td>
                <div class="actions-cell">
                  ...
                  <button
                    ...
                    class="bg-green-100 text-green-800 border-green-200 hover:bg-green-200"
                  >
                    Catálogo
                  </button>
                  <button
                    @click="cambioEstado(categoria)"
    ...
    <div v-if="!loading && totalPaginas > 1" class="flex flex-col items-center justify-center mt-4">
      ...
      <div class="flex items-center mt-2 space-x-1">
        <button
          ...
          class="w-8 h-8 flex items-center justify-center rounded-md bg-[#fffef9] border border-gray-200
